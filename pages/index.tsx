...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x6675A8A4711a8E9Ad41f4a45ef6B83332Ba2e861", "edition-drop").contract;
  // トークンコントラクトの初期化
  const token = useContract("0xB2C654f02ccdb44389cdeBC73b33e45F24cD08a9", "token").contract;
    // 投票コントラクトの初期化
    const vote = useContract("0x8dC9D15Bf31709042e8a40acF8Eb6A26dCcC2439", "vote").contract;
